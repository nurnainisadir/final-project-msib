            ...
            <div class="col-12">
                <div class="section-title">
                    <h3 class="m-0 font-weight-bold text-primary">Data Role</h3><br>
                        ...
                        <a href="{{ route('acl.role.create') }}">
                        <button type="button" class="btn btn-primary bi-plus btn-sm" title="Tambah Role"></button></a>
                    <br><br>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            @method('DELETE')
                                <a class="btn btn-warning btn-sm" title="Edit"
                                    href=" {{ route('acl.role.edit',$row->id) }}">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                &nbsp;
                                <button type="submit"
                                data-action="{{ route('acl.role.destroy',$row->id) }}"
